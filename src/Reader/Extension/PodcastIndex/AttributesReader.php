 ...
 *
 * @psalm-type LicenseObject = array{
 *        identifier: string,
 *        url: string
 *      }
 * @psalm-type LocationObject = array{
 *         description: string,
 *         geo?: string,
 *         osm?: string
 *       }
 * @psalm-type BlockObject = array{
 *          value: string,
 *          id?: string
 *        }
 * @psalm-type TxtObject = array{
 *          value: string,
 *          purpose?: string
 *        }
 ...
 *         height?: int,
 *       }
 * @psalm-type SocialInteractObject = array{
 *         protocol: string,
 *         uri: string,
 *         priority?: int,
 *         accountId?: string,
