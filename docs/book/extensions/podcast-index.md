...
| `getPodcastIndexChat()`                              | Returns information on the podcast's official chat. The output is an object with the properties `server`, `protocol`, `accountId` and `space`.                                                                                                                                                                           |
...
| `getPodcastIndexLocation()`                          | _Deprecated:_ Returns information on a single location entry. The output is an object with `description`, `geo`, `osm`, `rel` and `country` properties.                                                                                                                                                                  |
| `getPodcastIndexLocations()`                         | Returns information on multiple location entries. The output is an array of objects, each with `description`, `geo`, `osm`, `rel` and `country` properties.                                                                                                                                                              |
...
| `setPodcastIndexChat()`                              | Sets the tag [podcast:chat](https://github.com/Podcastindex-org/podcast-namespace/blob/main/docs/tags/chat.md). Expects an array with the required keys `server` and `protocol`, and the optional keys `accountId` and `space`.                                                                                                                                                                                                                                                                                                                                             |
...
| `setPodcastIndexLocation()`                          | _Deprecated:_ Sets a single [podcast:location](https://github.com/Podcastindex-org/podcast-namespace/blob/main/docs/tags/location.md) tag. Expects an array with the required key `description` (node value) and the optional keys `geo`, `osm`, `rel` and `country`.                                                                                                                                                                                                                                                                                                       |
| `addPodcastIndexLocation()`                          | Adds a [podcast:location](https://github.com/Podcastindex-org/podcast-namespace/blob/main/docs/tags/location.md) tag. Expects an array with the required key `description` (node value) and the optional keys `geo`, `osm`, `rel` and `country`.                                                                                                                                                                                                                                                                                                                            |
| `setPodcastIndexLocations()`                         | Sets multiple [podcast:location](https://github.com/Podcastindex-org/podcast-namespace/blob/main/docs/tags/location.md) tags. Expects an array of arrays, each with the required key `description` (node value) and the optional keys `geo`, `osm`, `rel` and `country`.                                                                                                                                                                                                                                                                                                    |
...
| `getPodcastIndexChat()`                              | Returns information on the episode's official chat. The output is an object with the properties `server`, `protocol`, `accountId` and `space`.                                                                                                                                                                                                                       |
...
| `getPodcastIndexDetailedImages()`                    | Returns the images. The output is an array of objects, each with the properties `href`, `alt`, `aspectRatio`, `width`, `height`, `type` and `purpose`.                                                                                                                                                                                                               |
| `getPodcastIndexLicense()`                           | Returns license information. The output is an object with `identifier` and `url` properties.                                                                                                                                                                                                                                                                         |
| `getPodcastIndexLocations()`                         | Returns location information. The output is an array of objects, each with `description`, `geo`, `osm`, `rel` and `country` properties.                                                                                                                                                                                                                              |
| `getPodcastIndexPeople()` `getPodcastIndexPersons()` | Returns information on the involved people. The output is an array of objects, each with the properties `name`, `role`, `group`, `img` and `href`.                                                                                                                                                                                                                   |
