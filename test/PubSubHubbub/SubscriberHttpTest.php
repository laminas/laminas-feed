...
class SubscriberHttpTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->_baseuri = constant('TESTS_LAMINAS_FEED_PUBSUBHUBBUB_BASEURI');
        if ($this->_baseuri) {
            ...
            $this->_client->setAdapter('\Laminas\Http\Client\Adapter\Socket');
            PubSubHubbub::setHttpClient($this->_client);
            $this->_subscriber = new Subscriber;

            $this->_storage = $this->_getCleanMock('\Laminas\Feed\PubSubHubbub\Model\Subscription');
