...
class ReaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testImportRemoteFeedMethodPerformsAsExpected()
    {
        ...
        $response = $this->getMock('Laminas\Feed\Reader\Http\ResponseInterface', array('getStatusCode', 'getBody'));
        ...
        $client = $this->getMock('Laminas\Feed\Reader\Http\ClientInterface', array('get'));
